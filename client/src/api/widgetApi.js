...
export const updateStrategyConfig = async (widgetId, config, strategyType) => {
    return await axios.put(`${endpoint}/widget/${widgetId}/price-strategy-config`, {config, strategyType})
}
